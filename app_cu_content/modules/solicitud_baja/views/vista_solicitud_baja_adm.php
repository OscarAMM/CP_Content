...
<style> td,th{	word-break: break-all; } </style>
...
<div class="panel panel-danger">
  ...
  <div class="panel-body">
  	<table class="table">
    	<tr><td colspan="2"><span class="titleInfo"><b>Área o plantel: </b> <?php echo $datosCCT['NOMBRECT']; ?></span></td>    	</tr>
    	<tr><td><span class="titleInfo"><b>Domicilio: </b> <?php echo $datosCCT['DOMICILIO']; ?></span></td><td><span class="titleInfo"><b>Población: </b> <?php echo $datosCCT['NOM'].', '.$datosCCT['NOMBRELOC']; ?></span></td>   	</tr>
    	<tr><td><span class="titleInfo"><b>Clave: </b> <?php echo $datosCCT['CLAVECCT']; ?></span></td><td><span class="titleInfo"><b>Zona: </b> <?php echo $datosCCT['ZONAESCOLA']; ?></span></td>   	</tr>
    	<tr><td><span class="titleInfo"><b>Turno: </b> <span style="text-transform:uppercase;"><?php echo $datosCCT['TURNO']; ?></span></span></td><td><span class="titleInfo"><b>Teléfono(s): </b>
        			<!--input type="text" value="<?php echo $datosCCT['TELEFONO']; ?>" name="telContacto" required-->
                    <input type="text" id="txt_tel_sol" value="<?=@$datos_cabecera[0]->TELEFONOS?>" name="telContacto" style="margin-right:3px;" disabled maxlength="15" size="18"/><input type="text" id="txt_tel_sol2" value="<?=@$datos_cabecera[0]->TELEFONOS2?>" name="telContacto2" disabled maxlength="15" size="18"/>
					<button id="btn_editTel" type="button" title="Editar teléfono" class="btn btn-default btn-xs" style="border:0" onclick="editar_telefono('Habilitar')"></span>
					  <span id="btn_icon_editTel" class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
					</button>
		</td></tr>
        <tr><td><span class="titleInfo"><b>Correo electrónico: </b>
                    <input type="text" id="txt_correo_sol" value="<?=@$datos_cabecera[0]->CorreoElectronico?>" name="correoContacto" style="margin-right:4px;" disabled size="40"/>
					<button id="btn_editCorreo" type="button" title="Editar Correo electrónico" class="btn btn-default btn-xs" style="border:0" onclick="editar_correo('Habilitar')"></span>
...
<div class="well btn-group" role="group">
  ...
  <label for="1"><span class="label label-danger">Paso 1</span> <a href="javascript:;" onclick="mensaje('Ayuda','Por favor, primero ingrese los archivos correspondientes a las evidencias para los bienes de esta solicitud','INFO');" class="btn btn-xs btn-info"> ? </a><br/><button rel="tabsB-3" type="button" class="botones btn btn-purple">Agregar evidencia</button></label>

	<label for="2"><span class="label label-danger">Paso 2</span> <a href="javascript:;" onclick="mensaje('Ayuda','<div><h4>Baja por diferencia de inventario</h4>Permite dar de baja bienes que no se tienen en el sistema o sin número de inventario.</div>','INFO');" class="btn btn-xs btn-info"> ? </a> <br/>
    <button rel="tabsB-1" type="button" class="botones btn btn-purple">Agregar bienes a la solicitud de baja</button> 
	<button rel="tabsB-2" type="button" id="nuev" class="botones btn btn-purple">Bajas por diferencia de inventario</button> 
	<button rel="tabsB-4" type="button" class="botones btn btn-purple" id="ver_anexos">Ver Evidencias de la solicitud</button></label> 
	
</div>
 <div id="tabsB-1" class="contenidos">
  <div id="tab-form-agregaBien" class="ui-widget-content ui-corner-all" ><div class="ui-widget-header ui-corner-all textLarge">Agregar bien</div>
    <p><img src="<?php echo INDEX_CP ?>resources/images/info.png" class='icon24' alt='Info'> En el siguiente listado puede encontrar los bienes que se tienen registrados en su centro de trabajo. 
    	Por favor seleccione los bienes del listado que quiere agregar a esta <b>solicitud de baja</b> 
    	haciendo clic en la casilla de la izquierda ( <input disabled type="checkbox"> ) y posteriormente clic en el botón ( <span class="label label-success">Incluir bien </span> )</p>
    <div class="alert alert-danger">
		<table id="tablaBienesCCT"></table>
		<div id="paginacionB"></div>
		<div class="alert alert-warning"><a href="javascript:;" onclick="menuIncluirBien();" class="btn btn-success textWhite"><img src="<?php echo INDEX_CP;?>resources/images/incluir.png" alt="Incluir" class="icon16"> Incluir bien</a></div>
	</div>
  </div>
  </div>
 <div id="tabsB-2" class="contenidos">
  <div id="tab-form-agregaBien" class="ui-widget-content ui-corner-all" ><div class="ui-widget-header ui-corner-all textLarge">Bajas por diferencia de inventario</div>
    <p><img src="<?php echo INDEX_CP ?>resources/images/info.png" class='icon24' alt='Info'> El siguiente formulario sirve para los bienes que no se encuentren en el listado de bienes asignados a su centro de trabajo, por lo que se dan de baja sin un número de inventario. 
    	Por favor rellene los campos necesario para ingresar bienes a esta <b>solicitud de baja</b> y posteriormente clic en el botón ( <span class="label label-success">Incluir bien </span> )</p>
        
<form id="frm_alta_guarda_bien" class="form-horizontal" name="frm_guarda_anexo" method="post" action="alta_bien_guardar">
	<input type="hidden" value="<?php echo $claveCT_ADM ?>" name="cct">
	<input type="hidden" value="<?php echo $turnoCT_ADM ?>" name="turno">
	...
	<div class="form-group">
        ...
        <div class="col-sm-4">
			<input type="text" name="input_cantidad" value="" id="input_cantidad" maxlength="5" size="10" class="form-control w50"><div class="error"></div>		
		</div>
	</div>
	<div class="form-group">
		<label for="lbl_descripcion" class="col-sm-2 control-label">Descripción  <span class="error">*</span></label>
        <div class="col-sm-4">
			<input type="text" name="DescripcionBien" value="" id="DescripcionBien" maxlength="45" size="50" class="form-control"><div class="error"></div>		
		</div>
	</div>
	<div class="form-group">
		<label for="lbl_marca" class="col-sm-2 control-label">Marca  <span class="error">*</span></label>
        <div class="col-sm-4">
			<input type="text" name="MarcaBien" value="" id="MarcaBien" maxlength="45" size="50" class="form-control"><div class="error"></div>	
            <label><input type="checkbox" id="marca_check" class="verifica_chek btn" /> <em><b>NA (No Aplica)</b></em></label>
		</div>
	</div>
	<div class="form-group">
		<label for="lbl_modelo" class="col-sm-2 control-label">Modelo  <span class="error">*</span></label>
        <div class="col-sm-4">
			<input type="text" name="ModeloBien" value="" id="ModeloBien" maxlength="45" size="50" class="form-control"><div class="error"></div>
            <label><input type="checkbox" id="marca_check" class="verifica_chek btn" /> <em><b>NA (No Aplica)</b></em></label>
		</div>
	</div>
	<div class="form-group">
        ...
        <div class="col-sm-4">
			<input type="text" name="SerieBien" value="" id="SerieBien" maxlength="45" size="50" class="form-control"><div class="error"></div>
            <label><input type="checkbox" id="marca_check" class="verifica_chek btn" /> <em><b>NA (No Aplica)</b></em></label>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
        ...
        <p>Nota: Si no le aparece alguna Evidencia, favor de recargar la página.</p>
			<select name="anexos[]" id="anexos_alta" class="anexos_agregar chosen-select form-control" data-placeholder="Seleccione Evidencia(s)" style="width:100%;min-width:350px; max-width:350px;" multiple tabindex="3">
				<?php echo $ANEXOS2; ?>
            </select><div class="error"></div>
		</div>
	</div>
...
$('.verifica_chek').change(function(e) {
	...
	$(".chosen-select").chosen({width:"100%", html_template: '<img style="margin-right: 5px; width: 50px; border: 2px solid black;" class="{class_name}" src="{url}" />'});
	...
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10">
			<input type="submit" name="btn_enviar" value="Guardar" id="btn_submit_form_bien" class="btn btn-success textWhite">	          <input type="reset" name="btn_cancelar" value="Cancelar" id="btn_can_alta_bien" class="btn btn-warning textWhite">
		</div>
	</div>	
</form>
<div class="error">* Campos obligatorios</div>
  ...
  <div id="tab-form-agregaBien" class="ui-widget-content ui-corner-all" ><div class="ui-widget-header ui-corner-all textLarge">Agregar evidencia</div>
   <?php echo $vista_anexos; ?>
  </div>
  <div id="tabsB-4" class="contenidos">
  <div id="tab-form-agregaBien" class="ui-widget-content ui-corner-all" ><div class="ui-widget-header ui-corner-all textLarge">Evidencia de solicitud</div>
   <div class="alert alert-warning" role="alert">
		<p>
			<img src="<?php echo INDEX_CP?>resources/images/info.png" class="icon24" alt="Info"> Evidencias relacionadas a los bienes de esta <b>solicitud de baja</b>.  	
		</p><br>
		<p>
			<b>NOTAS: </b> <span>
			</span></p><ul>
...
<script type="text/javascript" src="<?php echo INDEX_CP ?>resources/js/solicitud_baja_listado_adm.js"></script>
<script>
  $(function() {
    $( "#tabsBajas" ).tabs();
  });
