    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 order-md-1">
                <hr>
                <h1>Calendario de eventos próximos</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-4 order-md-3 alert alert-warning">
            <h3 class="text-muted text-center">¡Información!</h3>
            <div class="card card-body">
                <p>El siguiente apartado consta de tres secciones.
                <ol><li>Calendario: El calendario se desplegará todos los eventos registrados, mientras exista al menos un evento registrado.</li>
                <li>Lista de eventos: Aquí se desplegará una lista con todos los eventos agregados en el calendario</li>
                <li>Agregar: Se puede agregar eventos al calendario. Todos los agregados aparecerá en el calendario de arriba</li></ol></p>
            </div>
            </div>
        </div>
    </div>
